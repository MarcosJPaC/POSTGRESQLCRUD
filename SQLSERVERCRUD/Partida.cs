...
namespace SQLSERVERCRUD
{
    public partial class Partida : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionPGSQL.ejecutaConsultaSelect("SELECT *FROM Partida ORDER BY idPartida");
        }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE Partida SET estatus = False WHERE idPartida =  " + identificador.ToString(); ;
            ConexionPGSQL.ejecutaConsulta(consulta);
            MostrarDatos();
        }
