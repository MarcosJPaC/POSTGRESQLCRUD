...
namespace SQLSERVERCRUD
{
    public partial class Camuflaje : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionPGSQL.ejecutaConsultaSelect("SELECT *FROM Camuflaje ORDER BY idCamuflaje");
        }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE Camuflaje SET estatus = False WHERE idCamuflaje =  " + identificador.ToString(); ;
            ConexionPGSQL.ejecutaConsulta(consulta);
            MostrarDatos();
        }
