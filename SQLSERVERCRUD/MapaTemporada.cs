...
namespace SQLSERVERCRUD
{
    public partial class MapaTemporada : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionPGSQL.ejecutaConsultaSelect("SELECT *FROM MapaTemporada ORDER BY idMapaTemporada");
        }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE MapaTemporada SET estatus = False WHERE idMapaTemporada =  " + identificador.ToString(); ;
            ConexionPGSQL.ejecutaConsulta(consulta);
            MostrarDatos();
        }
