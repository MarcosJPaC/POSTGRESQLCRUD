...
namespace SQLSERVERCRUD
{
    public partial class AgenteEscuadron : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionPGSQL.ejecutaConsultaSelect("SELECT *FROM AgenteEscuadron ORDER BY idAgenteEscuadron");
        }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE AgenteEscuadron SET estatus = False WHERE idAgenteEscuadron =  " + identificador.ToString(); ;
            ConexionPGSQL.ejecutaConsulta(consulta);
            MostrarDatos();
        }
