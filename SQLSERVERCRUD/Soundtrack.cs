...
namespace SQLSERVERCRUD
{
    public partial class Soundtrack : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionPGSQL.ejecutaConsultaSelect("SELECT *FROM Soundtrack ORDER BY idSoundtrack");
        }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE Soundtrack SET estatus = False WHERE idSoundtrack =  " + identificador.ToString(); ;
            ConexionPGSQL.ejecutaConsulta(consulta);
            MostrarDatos();
        }
