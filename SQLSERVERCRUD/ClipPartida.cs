...
namespace SQLSERVERCRUD
{
    public partial class ClipPartida : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionPGSQL.ejecutaConsultaSelect("SELECT *FROM ClipPartida ORDER BY idClipPartida");
        }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE ClipPartida SET estatus = False WHERE idClipPartida =  " + identificador.ToString(); ;
            ConexionPGSQL.ejecutaConsulta(consulta);
            MostrarDatos();
        }
