...
namespace SQLSERVERCRUD
{
    public partial class JugadorPlataforma : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionPGSQL.ejecutaConsultaSelect("SELECT *FROM JugadorPlataforma ORDER BY idJugadorPlataforma");
        }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE JugadorPlataforma SET estatus = False WHERE idJugadorPlataforma =  " + identificador.ToString(); ;
            ConexionPGSQL.ejecutaConsulta(consulta);
            MostrarDatos();
        }
