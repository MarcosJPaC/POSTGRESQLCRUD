...
namespace SQLSERVERCRUD
{
    public partial class AgenteGesto : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionPGSQL.ejecutaConsultaSelect("SELECT *FROM AgenteGesto ORDER BY idAgenteGesto");
        }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE AgenteGesto SET estatus = False WHERE idAgenteGesto =  " + identificador.ToString(); ;
            ConexionPGSQL.ejecutaConsulta(consulta);
            MostrarDatos();
        }
