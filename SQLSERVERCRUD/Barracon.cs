...
namespace SQLSERVERCRUD
{
    public partial class Barracon : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionPGSQL.ejecutaConsultaSelect("SELECT *FROM Barracon ORDER BY idBarracon");
        }
        ...
        private void btnEliminar_Click_1(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE Barracon SET estatus = False WHERE idBarracon =  " + identificador.ToString(); ;
            ConexionPGSQL.ejecutaConsulta(consulta);
            MostrarDatos();
        }
