...
namespace SQLSERVERCRUD
{
    public partial class Clasificatoria : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionPGSQL.ejecutaConsultaSelect("SELECT *FROM Clasificatoria ORDER BY idClasificatoria");
        }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE Clasificatoria SET estatus = False WHERE idClasificatoria =  " + identificador.ToString(); ;
            ConexionPGSQL.ejecutaConsulta(consulta);
            MostrarDatos();
        }
