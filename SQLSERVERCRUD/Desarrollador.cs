...
namespace SQLSERVERCRUD
{
    public partial class Desarrollador : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionPGSQL.ejecutaConsultaSelect("SELECT *FROM Desarrollador ORDER BY idDesarrollador");
        }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE Desarrollador SET estatus = False WHERE idDesarrollador =  " + identificador.ToString(); ;
            ConexionPGSQL.ejecutaConsulta(consulta);
            MostrarDatos();
        }
