...
namespace SQLSERVERCRUD
{
    public partial class BarraconVehiculo : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionPGSQL.ejecutaConsultaSelect("SELECT *FROM BarraconVehiculo ORDER BY idBarraconVehiculo");
        }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE BarraconVehiculo SET estatus = False WHERE idBarraconVehiculo =  " + identificador.ToString(); ;
            ConexionPGSQL.ejecutaConsulta(consulta);
            MostrarDatos();
        }
