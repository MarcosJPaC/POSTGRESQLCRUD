...
namespace SQLSERVERCRUD
{
    public partial class Mision : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionPGSQL.ejecutaConsultaSelect("SELECT *FROM Mision ORDER BY idMision");
        }
        ...
        private void btnEliminar_Click_1(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE Mision SET estatus = False WHERE idMision =  " + identificador.ToString(); ;
            ConexionPGSQL.ejecutaConsulta(consulta);
            MostrarDatos();
        }
