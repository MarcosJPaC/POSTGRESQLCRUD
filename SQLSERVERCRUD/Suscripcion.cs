...
namespace SQLSERVERCRUD
{
    public partial class Suscripcion : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionPGSQL.ejecutaConsultaSelect("SELECT *FROM Suscripcion ORDER BY idSuscripcion");
        }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE Suscripcion SET estatus = False WHERE idSuscripcion =  " + identificador.ToString(); ;
            ConexionPGSQL.ejecutaConsulta(consulta);
            MostrarDatos();
        }
