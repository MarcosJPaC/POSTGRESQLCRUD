...
namespace SQLSERVERCRUD
{
    public partial class CapituloTemporada : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionPGSQL.ejecutaConsultaSelect("SELECT *FROM CapituloTemporada ORDER BY idCapituloTemporada");
        }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE CapituloTemporada SET estatus = False WHERE idCapituloTemporada =  " + identificador.ToString(); ;
            ConexionPGSQL.ejecutaConsulta(consulta);
            MostrarDatos();
        }
