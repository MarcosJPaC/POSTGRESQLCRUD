...
namespace SQLSERVERCRUD
{
    public partial class Parche : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionPGSQL.ejecutaConsultaSelect("SELECT *FROM Parche ORDER BY idParche");
        }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE Parche SET estatus = False WHERE idParche =  " + identificador.ToString(); ;
            ConexionPGSQL.ejecutaConsulta(consulta);
            MostrarDatos();
        }
