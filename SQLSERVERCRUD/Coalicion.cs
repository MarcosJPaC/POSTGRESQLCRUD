...
namespace SQLSERVERCRUD
{
    public partial class Coalicion : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionPGSQL.ejecutaConsultaSelect("SELECT *FROM Coalicion ORDER BY idCoalicion");
        }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE Coalicion SET estatus = False WHERE idCoalicion =  " + identificador.ToString(); ;
            ConexionPGSQL.ejecutaConsulta(consulta);
            MostrarDatos();
        }
